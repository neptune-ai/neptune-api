...
from ...models.attributes_requests_list_dto import AttributesRequestsListDTO
...
def _get_kwargs(
    *,
    body: AttributesRequestsListDTO,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/api/leaderboard/v1/attributes/floatSeries/csv/multiple",
    }
