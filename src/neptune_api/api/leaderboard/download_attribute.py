...
from ...models.download_attribute_expected_content_disposition import DownloadAttributeExpectedContentDisposition
from ...types import (
    UNSET,
    File,
    Response,
...
def _get_kwargs(
    *,
    ...
    expected_content_disposition: Union[
        Unset, DownloadAttributeExpectedContentDisposition
    ] = DownloadAttributeExpectedContentDisposition.ATTACHMENT,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/download",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        attribute (str):
        expected_content_disposition (Union[Unset, DownloadAttributeExpectedContentDisposition]):
            Default: DownloadAttributeExpectedContentDisposition.ATTACHMENT.
