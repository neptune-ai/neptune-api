...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/files",
        "params": params,
    }
...
) -> Optional[Union[Any, FileAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = FileAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, FileAttributeDTO]]:
    return Response(
