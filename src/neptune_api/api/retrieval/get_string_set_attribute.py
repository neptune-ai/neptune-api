...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/stringSets",
        "params": params,
    }
...
) -> Optional[Union[Any, StringSetAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = StringSetAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, StringSetAttributeDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, StringSetAttributeDTO]
    """
