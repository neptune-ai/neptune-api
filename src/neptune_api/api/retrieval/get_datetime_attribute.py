...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/datetimes",
        "params": params,
    }
...
) -> Optional[Union[Any, DatetimeAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = DatetimeAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, DatetimeAttributeDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, DatetimeAttributeDTO]
    """
