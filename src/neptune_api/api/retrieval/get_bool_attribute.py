...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/booleans",
        "params": params,
    }
...
) -> Optional[Union[Any, BoolAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = BoolAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, BoolAttributeDTO]]:
    return Response(
