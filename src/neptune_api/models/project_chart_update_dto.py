...
T = TypeVar("T", bound="ProjectChartUpdateDTO")


@_attrs_define
class ProjectChartUpdateDTO:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_chart_update_dto = cls(
            filters=filters,
            metrics=metrics,
            name=name,
        )

        project_chart_update_dto.additional_properties = d
        return project_chart_update_dto
