...
from ..models.leaderboard_view_update_dto_name_search_mode import LeaderboardViewUpdateDTONameSearchMode
from ..types import (
    UNSET,
    Unset,
)
...
T = TypeVar("T", bound="LeaderboardViewUpdateDTO")


@_attrs_define
class LeaderboardViewUpdateDTO:
    """
    Attributes:
        ...
        name_search_mode (Union[Unset, LeaderboardViewUpdateDTONameSearchMode]):
    ...
    name_search_mode: Union[Unset, LeaderboardViewUpdateDTONameSearchMode] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_name_search_mode, Unset):
            ...
            name_search_mode = LeaderboardViewUpdateDTONameSearchMode(_name_search_mode)
        ...
        return leaderboard_view_update_dto
