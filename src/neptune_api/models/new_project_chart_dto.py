...
T = TypeVar("T", bound="NewProjectChartDTO")


@_attrs_define
class NewProjectChartDTO:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_project_chart_dto = cls(
            filters=filters,
            metrics=metrics,
            name=name,
        )

        new_project_chart_dto.additional_properties = d
        return new_project_chart_dto
