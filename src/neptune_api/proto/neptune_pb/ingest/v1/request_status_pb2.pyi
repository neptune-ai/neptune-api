...
class RequestStatus(google.protobuf.message.Message):
    ...
    class CodeByCount(google.protobuf.message.Message):
        ...
        def __init__(self, *, code: google_rpc.code_pb2.Code.ValueType=..., count: builtins.int=...) -> None:
            ...

        def ClearField(self, field_name: typing_extensions.Literal['code', b'code', 'count', b'count']) -> None:
            ...
