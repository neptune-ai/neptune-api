...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_RUNOPERATIONBATCH']._serialized_start = 310
    _globals['_RUNOPERATIONBATCH']._serialized_end = 521