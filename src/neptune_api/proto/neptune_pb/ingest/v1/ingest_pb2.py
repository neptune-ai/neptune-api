...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BATCHPROJECTOPERATIONS_UPDATERUNSENTRY']._loaded_options = None
    _globals['_BATCHPROJECTOPERATIONS_UPDATERUNSENTRY']._serialized_options = b'8\x01'
    _globals['_BATCHRESULT_UPDATERUNRESULTSENTRY']._loaded_options = None
    _globals['_BATCHRESULT_UPDATERUNRESULTSENTRY']._serialized_options = b'8\x01'
    _globals['_INGESTCODE']._serialized_start = 2275
    _globals['_INGESTCODE']._serialized_end = 2926
    _globals['_UPDATERUNSNAPSHOTS']._serialized_start = 114
    _globals['_UPDATERUNSNAPSHOTS']._serialized_end = 191
    _globals['_BATCHCONTEXT']._serialized_start = 193
    _globals['_BATCHCONTEXT']._serialized_end = 241
    _globals['_UPDATERUN']._serialized_start = 243
    _globals['_UPDATERUN']._serialized_end = 329
    _globals['_BATCHPROJECTOPERATIONS']._serialized_start = 332
    _globals['_BATCHPROJECTOPERATIONS']._serialized_end = 644
    _globals['_BATCHPROJECTOPERATIONS_UPDATERUNSENTRY']._serialized_start = 565
    _globals['_BATCHPROJECTOPERATIONS_UPDATERUNSENTRY']._serialized_end = 644
    _globals['_CREATERUNERROR']._serialized_start = 646
    _globals['_CREATERUNERROR']._serialized_end = 768
    _globals['_CREATERUNRESULT']._serialized_start = 770
    _globals['_CREATERUNRESULT']._serialized_end = 886
    _globals['_RESULTSUMMARY']._serialized_start = 889
    _globals['_RESULTSUMMARY']._serialized_end = 1325
    _globals['_RESULTSUMMARY_FAILEDBYGRPCCODECOUNTERS']._serialized_start = 1158
    _globals['_RESULTSUMMARY_FAILEDBYGRPCCODECOUNTERS']._serialized_end = 1236
    _globals['_RESULTSUMMARY_INGESTCODECOUNTERS']._serialized_start = 1238
    _globals['_RESULTSUMMARY_INGESTCODECOUNTERS']._serialized_end = 1325
    _globals['_UPDATERUNERROR']._serialized_start = 1328
    _globals['_UPDATERUNERROR']._serialized_end = 1465
    _globals['_UPDATERUNRESULTS']._serialized_start = 1468
    _globals['_UPDATERUNRESULTS']._serialized_end = 1606
    _globals['_BATCHRESULT']._serialized_start = 1609
    _globals['_BATCHRESULT']._serialized_end = 2047
    _globals['_BATCHRESULT_UPDATERUNRESULTSENTRY']._serialized_start = 1955
    _globals['_BATCHRESULT_UPDATERUNRESULTSENTRY']._serialized_end = 2047
    _globals['_INGESTREQUEST']._serialized_start = 2049
    _globals['_INGESTREQUEST']._serialized_end = 2124
    _globals['_INGESTRESPONSE']._serialized_start = 2127
    _globals['_INGESTRESPONSE']._serialized_end = 2272