...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'neptune_pb/ingest/v1/ingest.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_INGESTCODE']._serialized_end = 2902
