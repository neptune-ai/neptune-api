...
class TimeseriesBucket(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal['_first', b'_first', '_last', b'_last', '_localMax', b'_localMax', '_localMin', b'_localMin', '_localSum', b'_localSum', 'first', b'first', 'last', b'last', 'localMax', b'localMax', 'localMin', b'localMin', 'localSum', b'localSum']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['_first', b'_first', '_last', b'_last', '_localMax', b'_localMax', '_localMin', b'_localMin', '_localSum', b'_localSum', 'finitePointCount', b'finitePointCount', 'first', b'first', 'fromX', b'fromX', 'index', b'index', 'last', b'last', 'localMax', b'localMax', 'localMin', b'localMin', 'localSum', b'localSum', 'nanCount', b'nanCount', 'negativeInfCount', b'negativeInfCount', 'positiveInfCount', b'positiveInfCount', 'toX', b'toX']) -> None:
        ...

    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal['_first', b'_first']) -> typing_extensions.Literal['first'] | None:
        ...
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal['_localMax', b'_localMax']) -> typing_extensions.Literal['localMax'] | None:
        ...

    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal['_localMin', b'_localMin']) -> typing_extensions.Literal['localMin'] | None:
        ...

    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal['_localSum', b'_localSum']) -> typing_extensions.Literal['localSum'] | None:
        ...
