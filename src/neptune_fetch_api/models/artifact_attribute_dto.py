...
T = TypeVar("T", bound="ArtifactAttributeDTO")


@_attrs_define
class ArtifactAttributeDTO:
    """
    Attributes:
        attribute_name (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        artifact_attribute_dto = cls(
            attribute_name=attribute_name,
            attribute_type=attribute_type,
            hash_=hash_,
        )

        artifact_attribute_dto.additional_properties = d
        return artifact_attribute_dto
