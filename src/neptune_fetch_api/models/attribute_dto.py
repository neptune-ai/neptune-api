...
if TYPE_CHECKING:
    from ..models.artifact_attribute_dto import ArtifactAttributeDTO
...
class AttributeDTO:
    ...
    Attributes:
        ...
        artifact_properties (Union[Unset, ArtifactAttributeDTO]):
    ...
    name: str
    type: AttributeTypeDTO
    artifact_properties: Union[Unset, "ArtifactAttributeDTO"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        artifact_properties: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.artifact_properties, Unset):
            artifact_properties = self.artifact_properties.to_dict()
        ...
        if artifact_properties is not UNSET:
            field_dict["artifactProperties"] = artifact_properties
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _artifact_properties = d.pop("artifactProperties", UNSET)
        artifact_properties: Union[Unset, ArtifactAttributeDTO]
        if isinstance(_artifact_properties, Unset):
            artifact_properties = UNSET
        else:
            artifact_properties = ArtifactAttributeDTO.from_dict(_artifact_properties)
