...
if TYPE_CHECKING:
    from ..models.experiment_attributes_dto import ExperimentAttributesDTO
    from ..models.leaderboard_entry_group_dto import LeaderboardEntryGroupDTO
    from ..models.leaderboard_field_suggestion_dto import LeaderboardFieldSuggestionDTO


T = TypeVar("T", bound="LeaderboardDTO")
...
class LeaderboardDTO:
    """
    Attributes:
        entries (List['ExperimentAttributesDTO']): The entries matching the given criteria.
        ...
        suggestions (Union[Unset, List['LeaderboardFieldSuggestionDTO']]): The column suggestions to the user, most
            recommended columns first.
        total_group_count (Union[Unset, int]): The total number of group entries.
    """

    entries: List["ExperimentAttributesDTO"]
    matching_item_count: int
    total_item_count: int
    groups: Union[Unset, List["LeaderboardEntryGroupDTO"]] = UNSET
    suggestions: Union[Unset, List["LeaderboardFieldSuggestionDTO"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for entries_item_data in _entries:
            entries_item = ExperimentAttributesDTO.from_dict(entries_item_data)
        ...
        for suggestions_item_data in _suggestions or []:
            suggestions_item = LeaderboardFieldSuggestionDTO.from_dict(suggestions_item_data)
        ...
        leaderboard_dto.additional_properties = d
        return leaderboard_dto
