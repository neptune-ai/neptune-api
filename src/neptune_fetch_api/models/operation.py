...
if TYPE_CHECKING:
    from ..models.assign_artifact_operation import AssignArtifactOperation
...
class Operation:
    ...
    Attributes:
        ...
        assign_artifact (Union[Unset, AssignArtifactOperation]):
    ...
    assign_artifact: Union[Unset, "AssignArtifactOperation"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        assign_artifact: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.assign_artifact, Unset):
            assign_artifact = self.assign_artifact.to_dict()
        ...
        if assign_artifact is not UNSET:
            field_dict["assignArtifact"] = assign_artifact
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _assign_artifact = d.pop("assignArtifact", UNSET)
        assign_artifact: Union[Unset, AssignArtifactOperation]
        if isinstance(_assign_artifact, Unset):
            assign_artifact = UNSET
        else:
            assign_artifact = AssignArtifactOperation.from_dict(_assign_artifact)
