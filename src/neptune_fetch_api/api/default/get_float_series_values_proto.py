...
from ...models.proto_float_series_values_dto import ProtoFloatSeriesValuesDTO
from ...types import (
    UNSET,
    Response,
    Unset,
...
) -> Optional[Union[Any, ProtoFloatSeriesValuesDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ProtoFloatSeriesValuesDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProtoFloatSeriesValuesDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ProtoFloatSeriesValuesDTO]
    """
