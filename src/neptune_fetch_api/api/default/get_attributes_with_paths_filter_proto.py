...
from ...models.proto_attributes_dto import ProtoAttributesDTO
from ...types import (
    UNSET,
    Response,
    Unset,
...
) -> Optional[Union[Any, ProtoAttributesDTO]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProtoAttributesDTO]]:
    return Response(
