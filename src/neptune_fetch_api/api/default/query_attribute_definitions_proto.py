...
from ...models.proto_attributes_search_result_dto import ProtoAttributesSearchResultDTO
from ...types import (
    UNSET,
    Response,
    Unset,
...
) -> Optional[Union[Any, ProtoAttributesSearchResultDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ProtoAttributesSearchResultDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ProtoAttributesSearchResultDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ProtoAttributesSearchResultDTO]
    """
