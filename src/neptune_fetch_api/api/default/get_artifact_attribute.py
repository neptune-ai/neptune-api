...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/artifacts",
        "params": params,
    }
...
) -> Optional[Union[Any, ArtifactAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ArtifactAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ArtifactAttributeDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ArtifactAttributeDTO]
    """
