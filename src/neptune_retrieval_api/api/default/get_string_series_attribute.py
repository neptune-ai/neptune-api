...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/stringSeries",
        "params": params,
    }
...
) -> Optional[Union[Any, StringSeriesAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = StringSeriesAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, StringSeriesAttributeDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, StringSeriesAttributeDTO]
    """
