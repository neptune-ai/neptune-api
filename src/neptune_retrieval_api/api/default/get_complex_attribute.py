...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/complexes",
        "params": params,
    }
...
) -> Optional[Union[Any, ComplexAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ComplexAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ComplexAttributeDTO]]:
    return Response(
