...
from ...models.image_series_values_dto import ImageSeriesValuesDTO
from ...types import (
    UNSET,
    Response,
    Unset,
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/series/image",
        "params": params,
    }
...
) -> Optional[Union[Any, ImageSeriesValuesDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ImageSeriesValuesDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ImageSeriesValuesDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ImageSeriesValuesDTO]
    """
