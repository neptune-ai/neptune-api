...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/floats",
        "params": params,
    }
...
) -> Optional[Union[Any, FloatAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = FloatAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, FloatAttributeDTO]]:
    return Response(
