...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/api/leaderboard/v1/attributes/floatSeries",
        "params": params,
    }
...
) -> Optional[Union[Any, FloatSeriesAttributeDTO]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = FloatSeriesAttributeDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, FloatSeriesAttributeDTO]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, FloatSeriesAttributeDTO]
    """
