...
class ProtoSeriesValuesResponseDTO(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal[('_nextPageToken', b'_nextPageToken', 'nextPageToken', b'nextPageToken', 'series', b'series')]) -> None:
        ...
...
class ProtoSeriesValuesSingleSeriesResponseDTO(google.protobuf.message.Message):
    ...
    FLOAT_SERIES_FIELD_NUMBER: builtins.int
    STRING_SERIES_FIELD_NUMBER: builtins.int
    requestId: builtins.str

    @property
    def float_series(self) -> global___ProtoFloatSeriesValuesDTO:
        ...
    ...
    def __init__(self, *, requestId: builtins.str=..., float_series: (global___ProtoFloatSeriesValuesDTO | None)=..., string_series: (global___ProtoStringSeriesValuesDTO | None)=...) -> None:
        ...

    def HasField(self, field_name: typing.Literal[('float_series', b'float_series', 'series', b'series', 'string_series', b'string_series')]) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing.Literal[('float_series', b'float_series', 'requestId', b'requestId', 'series', b'series', 'string_series', b'string_series')]) -> None:
        ...

    def WhichOneof(self, oneof_group: typing.Literal[('series', b'series')]) -> (typing.Literal[('float_series', 'string_series')] | None):
        ...
...
class ProtoStringSeriesValuesDTO(google.protobuf.message.Message):
    ...
    def __init__(self, *, total_item_count: builtins.int=..., values: (collections.abc.Iterable[global___ProtoStringPointValueDTO] | None)=...) -> None:
        ...
...
class ProtoStringPointValueDTO(google.protobuf.message.Message):
    ...
    def __init__(self, *, timestamp_millis: builtins.int=..., step: builtins.float=..., value: builtins.str=...) -> None:
        ...
