...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 28, 1, '', 'neptune_pb/api/v1/model/series_values.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PROTOFLOATPOINTVALUEDTO']._serialized_end = 523