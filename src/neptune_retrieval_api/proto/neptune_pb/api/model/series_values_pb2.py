...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_PROTOFLOATSERIESVALUESRESPONSEDTO']._serialized_start = 66
    _globals['_PROTOFLOATSERIESVALUESRESPONSEDTO']._serialized_end = 186
    _globals['_PROTOFLOATSERIESVALUESSINGLESERIESRESPONSEDTO']._serialized_start = 189
    _globals['_PROTOFLOATSERIESVALUESSINGLESERIESRESPONSEDTO']._serialized_end = 320
    _globals['_PROTOFLOATSERIESVALUESDTO']._serialized_start = 322
    _globals['_PROTOFLOATSERIESVALUESDTO']._serialized_end = 438
    _globals['_PROTOFLOATPOINTVALUEDTO']._serialized_start = 440
    _globals['_PROTOFLOATPOINTVALUEDTO']._serialized_end = 520