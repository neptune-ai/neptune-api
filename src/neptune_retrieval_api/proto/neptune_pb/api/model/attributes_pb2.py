...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _globals['_PROTOATTRIBUTESSEARCHRESULTDTO']._serialized_start = 111
    _globals['_PROTOATTRIBUTESSEARCHRESULTDTO']._serialized_end = 211
    _globals['_PROTOATTRIBUTEDEFINITIONDTO']._serialized_start = 213
    _globals['_PROTOATTRIBUTEDEFINITIONDTO']._serialized_end = 270
    _globals['_PROTOQUERYATTRIBUTESRESULTDTO']._serialized_start = 273
    _globals['_PROTOQUERYATTRIBUTESRESULTDTO']._serialized_end = 442
    _globals['_PROTONEXTPAGEDTO']._serialized_start = 444
    _globals['_PROTONEXTPAGEDTO']._serialized_end = 538
    _globals['_PROTOQUERYATTRIBUTESEXPERIMENTRESULTDTO']._serialized_start = 541
    _globals['_PROTOQUERYATTRIBUTESEXPERIMENTRESULTDTO']._serialized_end = 692