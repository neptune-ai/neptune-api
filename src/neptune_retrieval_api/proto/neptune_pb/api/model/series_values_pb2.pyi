...
class ProtoFloatPointValueDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, timestamp_millis: builtins.int = ..., step: builtins.float = ..., value: builtins.float = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["step", b"step", "timestamp_millis", b"timestamp_millis", "value", b"value"]
    ) -> None: ...
