...
class ProtoHistogram(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal['binValues', b'binValues', 'binsEdges', b'binsEdges', 'type', b'type']) -> None:
        ...
...
class ProtoFileRef(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal['mimeType', b'mimeType', 'path', b'path', 'size', b'size']) -> None:
        ...
