...
from ..models.new_version_dashboard_dto_type import NewVersionDashboardDTOType
from ..types import (
    UNSET,
    Unset,
)
...
T = TypeVar("T", bound="NewVersionDashboardDTO")


@_attrs_define
class NewVersionDashboardDTO:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        new_version_dashboard_dto.additional_properties = d
        return new_version_dashboard_dto
