...
T = TypeVar("T", bound="OptionalOperationError")


@_attrs_define
class OptionalOperationError:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        optional_operation_error = cls(
            empty=empty,
            present=present,
        )

        optional_operation_error.additional_properties = d
        return optional_operation_error
