...
T = TypeVar("T", bound="ExperimentStateAttributeDTO")


@_attrs_define
class ExperimentStateAttributeDTO:
    """
    Attributes:
        attribute_name (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        value = ExperimentStateDTO(d.pop("value"))

        experiment_state_attribute_dto = cls(
            attribute_name=attribute_name,
            attribute_type=attribute_type,
            value=value,
        )

        experiment_state_attribute_dto.additional_properties = d
        return experiment_state_attribute_dto
