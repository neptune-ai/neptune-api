...
if TYPE_CHECKING:
    from ..models.histogram_dto import HistogramDTO


T = TypeVar("T", bound="HistogramSeriesAttributeDTO")


@_attrs_define
class HistogramSeriesAttributeDTO:
    """
    Attributes:
        attribute_name (str):
        attribute_type (AttributeTypeDTO):
        last (Union[Unset, HistogramDTO]):
        last_step (Union[Unset, float]):
    """

    attribute_name: str
    attribute_type: AttributeTypeDTO
    last: Union[Unset, "HistogramDTO"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_last, Unset):
            ...
            last = HistogramDTO.from_dict(_last)

        last_step = d.pop("lastStep", UNSET)

        histogram_series_attribute_dto = cls(
        ...
        histogram_series_attribute_dto.additional_properties = d
        return histogram_series_attribute_dto
