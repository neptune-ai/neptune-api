...
T = TypeVar("T", bound="CheckpointListDTO")


@_attrs_define
class CheckpointListDTO:
    """
    Attributes:
        entries (List['CheckpointDTO']): The entries matching the given criteria.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for entries_item_data in _entries:
            entries_item = CheckpointDTO.from_dict(entries_item_data)
        ...
        checkpoint_list_dto = cls(
            entries=entries,
            matching_item_count=matching_item_count,
            total_item_count=total_item_count,
        )

        checkpoint_list_dto.additional_properties = d
        return checkpoint_list_dto
